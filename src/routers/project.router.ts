...
projectRouter.get(
  ...
  asyncHandler(projectControl.getProject)
); // 상세조회: 인증, 인가(멤버)
projectRouter.patch(
  '/:projectId',
  authenticate,
  authorize.projectOwner,
  asyncHandler(projectControl.updateProject)
); // 수정: 인증, 인가(오너)
projectRouter.delete(
  '/:projectId',
  authenticate,
  authorize.projectOwner,
  asyncHandler(projectControl.deleteProject)
); // 삭제: 인증, 인가(오너)
...
projectRouter.get(
  ...
  authenticate,
  authorize.projectMember,
  asyncHandler(projectControl.getMemberList)
); // 멤버조회: 인증, 인가(멤버)
projectRouter.delete(
  '/:projectId/users/:userId',
  authenticate,
  authorize.projectOwner,
  asyncHandler(projectControl.deleteMember)
); //멤버 제외: 인증, 인가(오너)
projectRouter.post(
  '/:projectId/invitations',
  authenticate,
  authorize.projectOwner,
  asyncHandler(projectControl.inviteMember)
); // 멤버 초대: 인증, 인가(오너)
...
projectRouter.post(
  ...
  authenticate,
  authorize.projectMember,
  asyncHandler(taskControl.createtask)
);
...
projectRouter.get(
  ...
  authenticate,
  authorize.projectMember,
  asyncHandler(taskControl.getList)
);
