...
// 프로젝트에 할 일 생성
taskRouter.post('/projects/:projectId/tasks', authenticate, authorize.projectMember, asyncHandler(taskControl.create));
...
// 할 일 수정
taskRouter.patch('/tasks/:taskId', authenticate, authorize.projectMember, asyncHandler(taskControl.update));
