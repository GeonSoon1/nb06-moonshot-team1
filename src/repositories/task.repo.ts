...
import { TaskWithDetails, taskInclude } from '../types/task';
...
//민수 추가(캘린더)
export const setGoogleEventId = (taskId: number, googleEventId: number) =>
  prisma.task.update({
    where: { id: taskId },
    data: { googleEventId },
    include: {
...
export const findDeleteMetaById = (id: number) =>
